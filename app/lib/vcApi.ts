...
export function isWalletApiMessage ({ messageObject }: { messageObject: object }): boolean {
...
export function parseWalletApiMessage ({ messageObject }: { messageObject: object }): WalletApiMessage | undefined {
  console.log('[parseWalletApiUrl] Parsing message object:',
...
export function parseWalletApiUrl ({ url }: { url: string }): object | undefined {
  console.log('[parseWalletApiUrl] Parsing url:', url);
